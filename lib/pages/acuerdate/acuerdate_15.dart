import 'package:calmar_la_ansiedad/pages/descubrimientos/descubrimiento_15.dart';
...
class Acuerdate15 extends StatefulWidget {
  @override
  State<Acuerdate15> createState() => _Acuerdate15State();
}

class _Acuerdate15State extends State<Acuerdate15> {
            ...
            BotonGordo(
                ...
                onpress: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Descubrimiento15()));
                }),
            BotonGordo(

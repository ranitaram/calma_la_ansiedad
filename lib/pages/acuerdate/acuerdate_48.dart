...
class Acuerdate48 extends StatefulWidget {
  @override
  State<Acuerdate48> createState() => _Acuerdate48State();
}

class _Acuerdate48State extends State<Acuerdate48> {
            ...
            BotonGordo(
                ...
                onpress: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Descubrimiento48()));
                }),
            BotonGordo(

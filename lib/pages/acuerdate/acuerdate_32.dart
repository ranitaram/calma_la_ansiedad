      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            ParrafoGrande(
              'Pon una nota en el espejo del baño, justo arriba o debajo de donde aparece tu imagen, que diga: “Esta persona podría morir esta noche.” Coloca notas similares cerca del teléfono o en tu lugar de trabajo,',
              color: Colors.white,
            ),
            Parrafo(
                'en sitios donde es probable que las veas mientras estás interactuando con otro.'),
            BotonGordo(

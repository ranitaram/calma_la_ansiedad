import 'package:calmar_la_ansiedad/pages/descubrimientos/descubrimiento_33.dart';
...
class Acuerdate33 extends StatefulWidget {
  @override
  State<Acuerdate33> createState() => _Acuerdate33State();
}

class _Acuerdate33State extends State<Acuerdate33> {
            ...
            BotonGordo(
                ...
                onpress: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Descubrimiento33()));
                }),
            BotonGordo(

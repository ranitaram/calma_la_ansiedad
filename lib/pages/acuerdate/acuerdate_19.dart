import 'package:calmar_la_ansiedad/pages/descubrimientos/descubrimiento_19.dart';
...
class Acuerdate19 extends StatefulWidget {
  @override
  State<Acuerdate19> createState() => _Acuerdate19State();
}

class _Acuerdate19State extends State<Acuerdate19> {
            ...
            BotonGordo(
                ...
                onpress: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Descubrimiento19()));
                }),
            BotonGordo(

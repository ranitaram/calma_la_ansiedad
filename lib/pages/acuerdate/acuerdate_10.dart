import 'package:calmar_la_ansiedad/pages/descubrimientos/descubrimiento_10.dart';
...
class Acuerdate10 extends StatefulWidget {
  @override
  State<Acuerdate10> createState() => _Acuerdate10State();
}

class _Acuerdate10State extends State<Acuerdate10> {
            ...
            BotonGordo(
                ...
                onpress: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Descubrimiento10()));
                }),
            BotonGordo(

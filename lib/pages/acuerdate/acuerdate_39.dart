import 'package:calmar_la_ansiedad/pages/descubrimientos/descubrimiento_39.dart';
...
class Acuerdate39 extends StatefulWidget {
  @override
  State<Acuerdate39> createState() => _Acuerdate39State();
}

class _Acuerdate39State extends State<Acuerdate39> {
            ...
            BotonGordo(
                ...
                onpress: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Descubrimiento39()));
                }),
            BotonGordo(

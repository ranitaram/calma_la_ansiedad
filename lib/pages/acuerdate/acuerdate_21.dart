import 'package:calmar_la_ansiedad/pages/descubrimientos/descubrimiento_21.dart';
...
class Acuerdate21 extends StatefulWidget {
  @override
  State<Acuerdate21> createState() => _Acuerdate21State();
}

class _Acuerdate21State extends State<Acuerdate21> {
            ...
            BotonGordo(
                ...
                onpress: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Descubrimiento21()));
                }),
            BotonGordo(

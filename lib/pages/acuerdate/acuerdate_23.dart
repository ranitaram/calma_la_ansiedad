import 'package:calmar_la_ansiedad/pages/descubrimientos/descubrimiento_23.dart';
...
class Acuerdate23 extends StatefulWidget {
  @override
  State<Acuerdate23> createState() => _Acuerdate23State();
}

class _Acuerdate23State extends State<Acuerdate23> {
            ...
            BotonGordo(
                ...
                onpress: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Descubrimiento23()));
                }),
            BotonGordo(

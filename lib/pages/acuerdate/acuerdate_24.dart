import 'package:calmar_la_ansiedad/pages/descubrimientos/descubrimiento_24.dart';
...
class Acuerdate24 extends StatefulWidget {
  @override
  State<Acuerdate24> createState() => _Acuerdate24State();
}

class _Acuerdate24State extends State<Acuerdate24> {
            ...
            BotonGordo(
                ...
                onpress: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Descubrimiento24()));
                }),
            BotonGordo(
